...
const Dashboard = () => {
  ...
  const [counters, setCounters] = React.useState(loadingMessage);
  const [employees, setEmployees] = React.useState(loadingMessage);
  const [gift_statuses, setGift_statuses] = React.useState(loadingMessage);
  const [logs, setLogs] = React.useState(loadingMessage);
    ...
    <>
      ...
      <SectionMain>
        ...
        >
          ...
          {hasPermission(currentUser, 'READ_COUNTERS') && (
            <Link href={'/counters/counters-list'}>
              <div
                className={`${
                  corners !== 'rounded-full' ? corners : 'rounded-3xl'
                } dark:bg-dark-900 ${cardsStyle} dark:border-dark-700 p-6`}
          ...
          {hasPermission(currentUser, 'READ_GIFT_STATUSES') && (
            <Link href={'/gift_statuses/gift_statuses-list'}>
              <div
                className={`${
                  corners !== 'rounded-full' ? corners : 'rounded-3xl'
                } dark:bg-dark-900 ${cardsStyle} dark:border-dark-700 p-6`}
