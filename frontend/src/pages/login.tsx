...
export default function Login() {
  ...
  const title = 'Corporate Gift Distribution System';
                ...
                <div>
                  <p className='mb-2'>
                    ...
                    <code
                      ...
                      data-password='48cf84c4'
                      onClick={(e) => setLogin(e.target)}
                    >
                      admin@flatlogic.com
                    </code>
                    {' / '}
                    <code className={`${textColor}`}>48cf84c4</code>
                    {' / '}
                    to login as Admin
                  </p>
                  <p>
                    ...
                    <code
                      className={`cursor-pointer ${textColor} `}
                      data-password='01804ab3ab92'
                      onClick={(e) => setLogin(e.target)}
                    >
                      client@hello.com
                    </code>
                    {' / '}
                    <code className={`${textColor}`}>01804ab3ab92</code>
                    {' / '}
                    to login as User
                  </p>
                </div>
